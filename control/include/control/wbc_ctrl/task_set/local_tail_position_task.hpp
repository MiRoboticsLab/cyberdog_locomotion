#ifndef LOCAL_TAIL_POSITION_TASK_HPP_
#define LOCAL_TAIL_POSITION_TASK_HPP_
...
/**
 * @brief Construct subtask of the tail position, contains three dimensions.
 *
 */
template < typename T > class LocalTailPosTask : public Task< T > {
public:
...
#endif  // LOCAL_TAIL_POSITION_TASK_HPP_
